 ...
 * Use the [JoinCampaignListFragment.newInstance] factory method to
...
class JoinCampaignListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment JoinCampaignListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            JoinCampaignListFragment().apply {
